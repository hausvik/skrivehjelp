...
<table style="border-collapse: collapse; width: 100%;">
    ...
    <p class="MsoNormal" style="font-size: 11pt; font-style: italic;">${engelsk ? "The document is electronically approved and therefore has no handwritten signatures." : "Dokumentet er elektronisk godkjent og har derfor ingen håndskrevne signaturer."}</p>
        `;
}
